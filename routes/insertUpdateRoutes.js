...
router.post('/send-email', async (req, res) => { 
  ...
  const patientText = (
    `
      ...
      Your Medicare Insurance Agent, ${broker_first_name} ${broker_last_name}, has sent you a link that will allow you to enroll in
      ...
      schedule you for your preventative health screening.
      Please <a href="https://www.welltrackone.com/web-patients">click here</a> to enroll in the program and you’ll be contacted by one of our clinical team
      right away.
      Thank you,
      On behalf of {broker_first_name} {broker_last_name}
    `
  );

  const brokerText = (
    `
      Thank you for submitting your client – ${firstName} ${lastName}
    `
  )
  const msg_broker = {
    to: broker_email,
